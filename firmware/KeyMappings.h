...
*/
// QWERTY table entries were auto generated from /keycodes/main.c
...
// Set to non-zero value to use ABC keyboard layout instead of QWERTY.
#define KEYBOARD_ABC 1
...
static const RowMapping g_col0RowMappings[] =
{
    ...
    {0x00000800, HID_KEY_K},
    {0x00000400, HID_KEY_L},
    {0x00000200, HID_KEY_M},
    {0x00000100, HID_KEY_N},
    {0x00000080, HID_KEY_Q},
    {0x00000040, HID_KEY_R},
    {0x00000020, HID_KEY_S},
...
static const RowMapping g_col1RowMappings[] =
{
    ...
    {0x00000100, HID_KEY_O},
    {0x00000080, HID_KEY_P},
...
static const RowMapping g_col2RowMappings[] =
{
    ...
    {0x00000800, HID_KEY_T},
    {0x00000400, HID_KEY_U},
    {0x00000200, HID_KEY_V},
    {0x00000100, HID_KEY_W},
    {0x00000080, HID_KEY_Z},
...
static const RowMapping g_col16RowMappings[] =
{
    ...
    {0x00000100, HID_KEY_E},
    {0x00000080, HID_KEY_F},
...
static const RowMapping g_col17RowMappings[] =
{
    ...
    {0x00000400, HID_KEY_B},
    {0x00000200, HID_KEY_C},
    {0x00000100, HID_KEY_D},
    {0x00000080, HID_KEY_G},
    {0x00000040, HID_KEY_H},
    {0x00000020, HID_KEY_I},
    {0x00000010, HID_KEY_J},
};
